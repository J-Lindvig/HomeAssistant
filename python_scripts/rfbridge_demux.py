sensors = {
  ...
  "BE8614": ["alarm/command", "ARMHOME", "false"],
  "BE8611": ["alarm/command", "ARM_AWAY", "false"],
  "42AAA9": ["alarm/command", "ARM_AWAY", "false"],
  "42AAAA": ["alarm/command", "DISARM", "false"],
  386608: ["alarm/command", "ARM_AWAY", "false"],
  "FF5F71": ["alarm/command", "DISARM", "false"],
